...
using StoreDDD.Infrastructure.EntityConfigurations;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;

namespace StoreDDD.Infrastructure.Context
{
    /// <summary>
    /// Class StoreContext.
    /// </summary>
    public class StoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(config.GetConnectionString("DomainStore"));
        }
    }
}
