...
namespace StoreDDD.DomainLayer.AggregatesModels.Products.Models
{
    /// <summary>
    /// Class Product.
    /// </summary>
    public class Product : Entity, IAggregateRoot
    {
        ...
        public static Product UpdateWhithoutCode(Guid id, string name, int quantity, decimal cost)
        {
            var product = new Product
            {
                Id = id,
        ...
        public static Product Update(Guid id, string code, string name, int quantity, decimal cost)
        {
            return new Product
            {
                Id = id,
